...
def main(dir_path, 
    ...
    onlyfiles = [f for f in listdir(dir_path_parsed) if isfile(join(dir_path_parsed, f))]
    print(onlyfiles)
    ...
    for f in onlyfiles:
        ...
        for _, row in tqdm(pages.iterrows()):
            ...
            for q in response.split('\n\n'):
                if q:
                    question, choice_1, choice_2, choice_3, choice_4, choice_5 = parse_gpt_output(q)
                    
                    new_row = {'category_a': None,
                               'category_b': None,
                               'category_og_en': None,
                               'category_og': None,
                               'level': None,
